...
ds_small = xr.open_dataset('/uufs/chpc.utah.edu/common/home/steenburgh-group7/tom/cm1/cm1r19/run/output/cm1run_20ms_0500m_new_sounding.nc')
...
for i in range(0,np.min([ds_no.dbz[:,0,0,0].size, ds_small.dbz[:,0,0,0].size, ds_tall.dbz[:,0,0,0].size])):
    ...
    for j in range(1,4):
        ...
        #Levels for variable
        levels = np.arange(5,50.01,0.5)
        levels_ticks = np.arange(5,50.01,5)
        
        #Plot variable
        ref_plot = plt.contourf(x2d, y2d, model_run.dbz[i,zmin:zmax[j-1],ymid,xmin:xmax], levels, cmap = cmap_precip, extend = 'max', alpha = 1)
        ...
        #Labels
        sub_title = ['500m Mountain/Low Wind', '500m Mountain/Low Wind/New Sounding', '2500m Mountain/Low Wind']
    ...
    plt.savefig("/uufs/chpc.utah.edu/common/home/u1013082/public_html/phd_plots/cm1/png_for_gifs/3panel_cross_section_20ms_newsound_dbz_%03d.png" % i, dpi = 100)
    plt.close(fig)
    

##Build GIF

os.system('convert -delay 12 -quality 100 /uufs/chpc.utah.edu/common/home/u1013082/public_html/phd_plots/cm1/png_for_gifs/3panel_cross_section_20ms_newsound_dbz*.png /uufs/chpc.utah.edu/common/home/u1013082/public_html/phd_plots/cm1/gifs/3panel_cross_section_20ms_newsound_dbz.gif')
